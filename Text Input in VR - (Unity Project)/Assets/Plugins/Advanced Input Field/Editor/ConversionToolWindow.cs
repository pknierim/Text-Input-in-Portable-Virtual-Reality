...
namespace AdvancedInputFieldPlugin.Editor
{
	...
	public class ConversionToolWindow: EditorWindow
	{
		...
		[MenuItem("Advanced Input Field/ConversionTool")]
		public static void Init()
		{
			ConversionToolWindow window = (ConversionToolWindow)EditorWindow.GetWindowWithRect(typeof(ConversionToolWindow), new Rect(0, 0, 360, 240), true, "Conversion Tool");
			window.Show();
		}
